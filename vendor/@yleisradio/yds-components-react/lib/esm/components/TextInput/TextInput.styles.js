...
const TextInputFieldset = styled.fieldset.withConfig({
...
const TextInputDescription = styled.p.withConfig({
...
const TextInputErrorMessage = styled(TextInputDescription).withConfig({
...
const InputAndIconContainer = styled.div.withConfig({
...
const InputIconWrapper = styled.span.withConfig({
  ...
  switch ($location) {
    case 'before':
      return css(["left:0;padding-left:8px;"]);
    case 'after':
      return css(["right:0;padding-right:8px;"]);
    default:
      // 'middle' and 'clearSubmit'
      return css(["right:48px;width:32px;padding-left:8px;"]);
  }
});
const LoadingIndicatorWrapper = styled.span.withConfig({
  ...
  $isDisabled,
  theme
}) => $isDisabled && css(["& .yds-spinner path{stroke:", ";}"], theme.yds.TEXT_DISABLED));
const InputButtonIcon = styled.button.withConfig({
...
export { InputAndIconContainer, InputButtonIcon, InputIconWrapper, LoadingIndicatorWrapper, StyledTextInput, TextInputDescription, TextInputErrorMessage, TextInputFieldset };
