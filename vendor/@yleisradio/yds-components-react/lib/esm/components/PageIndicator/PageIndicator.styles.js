...
const StyledPageIndicatorContainer = styled.div.withConfig({
  componentId: "ydscr__sc-1ib0xq8-0"
})(["display:flex;gap:", ";align-items:center;"], ({
  theme
}) => ydsThemeUnit('12px', theme.ydsThemeProps.unit, theme.ydsThemeProps.baseUnit));
const StyledPageIndicator = styled.button.withConfig({
  ...
  theme
}) => ydsThemeUnit('12px', theme.ydsThemeProps.unit, theme.ydsThemeProps.baseUnit), radius.FULL, ({
  theme,
  $active
  ...
  $active,
  theme
}) => $active ? theme.yds.ACTION_PRIMARY_VARIANT : theme.yds.ACTION_UNSELECTED, radius.FULL, ({
  $active,
  theme
...
export { StyledPageIndicator, StyledPageIndicatorContainer };
