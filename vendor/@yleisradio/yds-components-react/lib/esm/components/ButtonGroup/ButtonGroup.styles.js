...
const ButtonGroupButtonBase = styled(Button).withConfig({
  componentId: "ydscr__sc-16zhhns-1"
})(["border-radius:", ";gap:4px;&:focus-visible{border-radius:", ";}", "{padding-left:0;padding-right:0;}", "{& svg{width:", ";height:", ";}}"], radius.LARGE, radius.LARGE, TextWrapper, IconWrapper, props => ydsThemeUnit('16px', props.theme.ydsThemeProps.unit, props.theme.ydsThemeProps.baseUnit), props => ydsThemeUnit('16px', props.theme.ydsThemeProps.unit, props.theme.ydsThemeProps.baseUnit));
const ButtonGroupButtonPrimary = styled(ButtonGroupButtonBase).withConfig({
  componentId: "ydscr__sc-16zhhns-2"
})(["background-color:", ";color:", ";border:none;", " position:relative;span{z-index:10;}&:active{background-color:", ";&::before{border-radius:", ";position:absolute;content:'';top:0;left:0;width:100%;height:100%;background-color:", ";z-index:1;}}@media (hover:hover){&:hover{background-color:", ";&::before{border-radius:", ";position:absolute;content:'';top:0;left:0;width:100%;height:100%;background-color:", ";z-index:1;}}}", " &[aria-disabled=\"true\"]:hover{background-color:", ";&::before{background-color:transparent;}}"], props => props.$selected ? props.theme.yds.ACTION_SELECTED : props.theme.yds.ACTION_UNSELECTED, props => props.$selected ? props.theme.yds.TEXT_NEGATIVE : props.theme.yds.TEXT_DEFAULT, props => primarySizeRules(props.theme)[props.$size], props => props.$selected ? props.theme.yds.ACTION_PRIMARY_VARIANT : props.theme.yds.ACTION_UNSELECTED, radius.LARGE, props => props.$selected ? 'transparent' : props.theme.yds.ACTION_SECONDARY_VARIANT, props => props.$isDisabled ? props.theme.yds.ACTION_DISABLED : props.$selected ? props.theme.yds.ACTION_PRIMARY_VARIANT : props.theme.yds.ACTION_UNSELECTED, radius.LARGE, props => props.$isDisabled ? 'transparent' : props.$selected ? 'transparent' : props.theme.yds.ACTION_SECONDARY_VARIANT, props => props.$isDisabled && css`
...
const ButtonGroupButtonSecondary = styled(ButtonGroupButtonBase).withConfig({
...
export { ButtonGroupButtonBase, ButtonGroupButtonPrimary, ButtonGroupButtonSecondary, StyledButtonGroup };
