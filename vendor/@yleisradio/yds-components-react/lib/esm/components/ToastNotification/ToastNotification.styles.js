...
import { BaseNotification } from '../../internal/components/BaseNotification/BaseNotification.js';
import { ydsThemeUnit } from '../../helpers/ydsThemeUnit.js';
import { NotificationCloseButton } from '../../internal/components/BaseNotification/BaseNotification.styles.js';
...
const ToastNotificationContainer = styled.div.withConfig({
...
const ToastMotion = styled.div.withConfig({
  ...
  transitionDuration: transition.DURATION_M,
  transitionTimingFunction: transition.EASING_DEC,
  height: $height,
  width: 'calc(100% - 32px)',
  '@media (prefers-reduced-motion: reduce)': {
    transitionProperty: 'none'
  },
  maxWidth: ydsThemeUnit('400px', theme.ydsThemeProps.unit, theme.ydsThemeProps.baseUnit)
}));
const StyledNotification = styled(BaseNotification).withConfig({
...
export { Progress, ProgressContainer, StyledNotification, ToastMotion, ToastNotificationContainer };
