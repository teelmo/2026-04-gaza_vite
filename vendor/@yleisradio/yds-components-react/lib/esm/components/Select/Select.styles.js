...
const SelectFieldset = styled.fieldset.withConfig({
...
const SelectElement = styled.select.withConfig({
...
const FormElementErrorMessage = styled(FormElementDescription).withConfig({
  componentId: "ydscr__sc-110zd1q-5"
})(["color:", ";"], props => props.theme.yds.FEEDBACK_ERROR);

export { FormElementDescription, FormElementErrorMessage, OptionElement, SelectElement, SelectFieldset, SelectWrapper };
