...
const NotificationBase = styled.div.withConfig({
  ...
  $notificationType
          ...
          border-radius: 0;
        ` : '');
const NotificationGrid = styled.div.withConfig({
...
const NotificationContent = styled.div.withConfig({
  componentId: "ydscr__sc-ogfirk-3"
})(["grid-area:content;align-self:center;"]);
const NotificationText = styled.div.withConfig({
...
const NotificationIcon = styled.div.withConfig({
  ...
  theme
}) => ydsThemeUnit('24px', theme.ydsThemeProps.unit, theme.ydsThemeProps.baseUnit), ({
  theme
}) => ydsThemeUnit('24px', theme.ydsThemeProps.unit, theme.ydsThemeProps.baseUnit), ({
  $notificationType
}) => $notificationType === 'banner' ? css`
        ...
        ` : '');
const NotificationCloseContainer = styled.div.withConfig({
...
const NotificationCloseButton = styled(Button).withConfig({
...
const NotificationActionsContainer = styled.div.withConfig({
...
export { NotificationActionsContainer, NotificationBase, NotificationCloseButton, NotificationCloseContainer, NotificationContent, NotificationGrid, NotificationIcon, NotificationText, NotificationTitle };
