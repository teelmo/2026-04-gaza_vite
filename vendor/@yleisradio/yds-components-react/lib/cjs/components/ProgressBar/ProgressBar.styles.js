...
const stripeMove = styledComponents.keyframes(["0%{background-position:0 0;}100%{background-position:24px 0;}"]);
const indeterminateAnimation = styledComponents.css(["", " 0.6s linear infinite"], stripeMove);
const ProgressBarWrapper = styledComponents.styled.div.withConfig({
...
const LabelWrapper = styledComponents.styled.div.withConfig({
  componentId: "ydscr__sc-18fglbh-1"
})({
  display: 'flex',
  alignItems: 'center',
  justifyContent: 'space-between',
  gap: ydsCore.spacing.SPACING_12
});
const LabelText = styledComponents.styled.span.withConfig({
...
const StatusIcon = styledComponents.styled.span.withConfig({
...
const Track = styledComponents.styled.div.withConfig({
...
const Description = styledComponents.styled.span.withConfig({
