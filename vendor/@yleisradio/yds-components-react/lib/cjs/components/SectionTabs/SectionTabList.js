...
const SectionTabList = _a => {
  ...
  var {
    ...
    rest = tslib_es6.__rest(_a, ["children", "enableTransitions"]);
  const {
    activeTab,
    setActiveTab
  ...
  const updateBackgroundStyle = React.useCallback(() => {
    var _a;
    ...
    if (activeTabElement) {
      ...
      setBackgroundStyle({
        ...
        transitionDuration: shouldDisableTransition ? ydsCore.transition.DURATION_INSTANT : ydsCore.transition.DURATION_S
      });
    }
  ...
  return jsxRuntime.jsx(SectionTabs_styles.StyledTabList, Object.assign({
    role: "tablist",
    ref: tabListRef,
...
exports.SectionTabList = SectionTabList;
