...
var BottomSheet_styles = require('./BottomSheet.styles.js');
...
const BottomSheet = _a => {
  var {
    ...
    rest = tslib_es6.__rest(_a, ["bottomSheetRef", "title", "titleAs", "onClose", "dragToClose", "align", "nonModal", "closeOnOutsideClick", "size", "children"]);
  ...
  const animateBackdropOpacity = React.useCallback((targetOpacity, duration) => {
  ...
  const animateSnapBack = React.useCallback(dragDistance => {
    if (contentRef.current) {
      const snapBackDuration = Math.max(50, Math.round(dragDistance / DRAG_CLOSE_THRESHOLD * parseInt(ydsCore.transition.DURATION_S)));
      contentRef.current.style.transform = 'translateY(0)';
      contentRef.current.style.transition = `transform ${snapBackDuration}ms ${ydsCore.transition.EASING_DEFAULT}`;
  ...
  const closeBottomSheet = React.useCallback((dragDistance = 0) => {
    var _a;
    ...
    const baseDuration = parseInt(ydsCore.transition.DURATION_S);
    ...
    if (contentRef.current) {
      const easing = dragDistance > 0 ? ydsCore.transition.EASING_DEC : ydsCore.transition.EASING_DEFAULT;
  ...
  React.useImperativeHandle(bottomSheetRef, () => ({
    open: () => {
      ...
      if (nonModal) {
        ...
        animateBackdropOpacity(1, parseInt(ydsCore.transition.DURATION_S));
      }
      setIsOpen(true);
    },
    close: () => {
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [!nonModal && jsxRuntime.jsx(BottomSheet_styles.DisableBodyScroll, {}), jsxRuntime.jsx(BottomSheet_styles.StyledBottomSheetDialog, Object.assign({
      ref: dialogRef,
      closedby: "none",
      "$align": align,
      "$backdropOpacity": backdropOpacity
    }, rest, {
      children: jsxRuntime.jsxs(BottomSheet_styles.BottomSheetContainer, {
        ref: contentRef,
        "$size": size,
        children: [jsxRuntime.jsxs(BottomSheet_styles.BottomSheetHeader, {
          children: [dragToClose ? jsxRuntime.jsx(BottomSheet_styles.DragHandle, {
            "aria-label": "Close bottom sheet",
            onClick: () => closeBottomSheet(),
            onPointerDown: handleDragStart,
            onPointerMove: handleDragMove,
            onPointerUp: handleDragEnd
          }) : jsxRuntime.jsx(BottomSheet_styles.CloseButton, {
          ...
          }), title && jsxRuntime.jsx(BottomSheet_styles.BottomSheetTitle, {
            as: titleAs,
            "$dragToClose": dragToClose,
            children: title
          })]
        }), jsxRuntime.jsx(BottomSheet_styles.BottomSheetContent, {
          children: children
        })]
      })
    }))]
