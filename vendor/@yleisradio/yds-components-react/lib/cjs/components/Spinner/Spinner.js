...
const Spinner = _a => {
  var {
    ...
    other = tslib_es6.__rest(_a, ["size", "variant", "hasBackground", "label", "colors"]);
  return jsxRuntime.jsxs(Spinner_styles.SpinnerWrapper, Object.assign({
    className: "yds-spinner-wrapper",
    "$variant": variant
  }, other, {
    children: [jsxRuntime.jsxs(Spinner_styles.SpinnerBase, {
      className: "yds-spinner",
      viewBox: "0 0 72 72",
      "$size": size,
      children: [hasBackground && jsxRuntime.jsx(Spinner_styles.SpinnerBackground, {
        cx: "36",
        cy: "36",
        r: "30",
        ...
        "$variant": variant,
        "$colors": colors
      }), jsxRuntime.jsx(Spinner_styles.SpinnerWheel, {
    ...
    }), label && jsxRuntime.jsx(Spinner_styles.SpinnerLabel, {
      children: label
    })]
  }));
};
