...
var TextInput_styles = require('../TextInput/TextInput.styles.js');

const SearchInputSubmit = styledComponents.styled(TextInput_styles.InputButtonIcon).withConfig({
...
exports.SearchInputSubmit = SearchInputSubmit;
