...
const DisableBodyScroll = styledComponents.createGlobalStyle`
  :root {
    &:has(dialog[open]) {
...
`;
const StyledModal = styledComponents.styled.dialog.withConfig({
...
const ModalContent = styledComponents.styled.div.withConfig({
  ...
  theme
}) => theme.yds.TEXT_DEFAULT, ydsCore.radius.LARGE, ({
  $scrollBehavior
